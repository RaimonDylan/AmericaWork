...
$job = $controller->getInfoJob($job_id);
include_once('../../includes/headerPublic.php');
?>

    <div class="unit-5 overlay" style="background-image: url('../../res/images/hero_bg_2.jpg');">
      <div class="container text-center">
        <h2 class="mb-0">Voir une annonce</h2>
        <p class="mb-0 unit-6"><a href="../../index.php">Accueil</a> <span class="sep">></span> <span>Voir une annonce</span></p>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form class="form" action="" method="post"  id="customer_form" enctype="multipart/form-data">
                  <?php  include_once('../forms/voirJobPublic_form.php'); ?>
              </form>
          </div>
